    ...
    public partial class AddMoreProducts : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Description", "ImageUrl", "Title" },
                values: new object[] { "The Hitchhiker's Guide to the Galaxy is a 2005 science fiction comedy film directed by Garth Jennings, based upon previous works in the media franchise of the same name, created by Douglas Adams. It stars Martin Freeman, Sam Rockwell, Mos Def, Zooey Deschanel, Bill Nighy, Anna Chancellor, John Malkovich, and the voices of Stephen Fry, Helen Mirren, Thomas Lennon, Richard Griffiths, Ian McNeice, Bill Bailey and Alan Rickman. Adams co-wrote the screenplay with Karey Kirkpatrick but died in 2001, before production began; the film is dedicated to Adams. The film received positive reviews from critics and grossed over $100 million worldwide.", "https://upload.wikimedia.org/wikipedia/en/7/7a/Hitchhikers_guide_to_the_galaxy.jpg", "The Hitchhiker's Guide to the Galaxy (film)" });
